...
<PodcastEmbed src="https://open.spotify.com/episode/1r0qx9g7bvBWfXmURITiOV?si=rM2ylHnwT6G_DmLP2R7tiQ" />
...
:::tip[Instrument it]
A model is only ever as good as the data you collect, and that is a sensor-placement and sampling problem before it is a machine-learning one. Record from the sensor mounted exactly as it will be in the field, at a sample rate that captures the phenomenon (Nyquist again), across the full range of normal conditions you expect, not just a tidy afternoon on the bench. Label honestly, and the device you deploy will [recognise the real world](https://siliconwit.io) instead of your test rig.
:::
