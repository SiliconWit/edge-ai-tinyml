...
| **No connectivity needed** | The model is baked into firmware. Works offline. |
...
| **Low cost** | A $2 MCU replaces a $50 SBC or a cloud API subscription. |
