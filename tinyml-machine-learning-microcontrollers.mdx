...
extern "C" void app_main(void) {
    ...
    ESP_LOGI(TAG, "Input  scale=%.6f  zero_point=%ld", input_scale, input_zero_point);
    ESP_LOGI(TAG, "Output scale=%.6f  zero_point=%ld", output_scale, output_zero_point);
    ...
    for (int i = 0; i < num_points; i++) {
        ...
        // Quantize the input
        int8_t x_quantized = (int8_t)((x / input_scale) + input_zero_point);
