...
|-----|-----------|----------|-------|
| U1 | RPi Pico W | 1 | Reuse from Pico course |
| U2 | STM32F4 dev board (e.g., Nucleo-F446RE) | 1 | Reuse from STM32 course |
...
class MPU6050:
    ...
    def read_raw(self):
        ...
        # Return ax, ay, az, gx, gy, gz (skip temperature)
        return vals[0], vals[1], vals[2], vals[3], vals[4], vals[5]
        # Note: vals[3] is temp, vals[4:7] is gyro. Fix indexing:
        # accel = vals[0:3], temp = vals[3], gyro = vals[4:7]
...
:::note
The `read_raw` method returns 7 values from the 14-byte burst read. The order is: accel_x, accel_y, accel_z, temperature, gyro_x, gyro_y, gyro_z. We skip the temperature value in `read_scaled`. Adjust the indexing if your struct unpacking differs.
:::
